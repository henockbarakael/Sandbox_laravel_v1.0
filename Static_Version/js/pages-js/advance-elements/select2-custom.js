...
$(document).ready(function(){
    ...
    $('#custom-header1').multiSelect({
        selectableHeader: "<div class='bg-info p-2'>Selectable items</div>",
        selectionHeader: "<div class='bg-info p-2'>Selection items</div>",
        selectableFooter: "<div class='bg-info p-2'>Selectable footer</div>",
        selectionFooter: "<div class='bg-info p-2'>Selection footer</div>"
    });
    // Single Select
