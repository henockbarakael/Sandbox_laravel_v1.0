  ...
  $(document).ready(function () {
      ...
      $('#edit-cancel').on('click', function () {
          ...
          c.removeClass('fa fa-close');
          c.addClass('fa fa-edit');
          $('#view-info').show();
          $('#edit-info').hide();
      });
      ...
      $('#edit-btn').on('click', function () {
          ...
          if (edit_class == 'fa fa-edit') {
              b.removeClass('fa fa-edit');
              b.addClass('fa fa-close');
              $('#view-info').hide();
              $('#edit-info').show();
          } else {
              b.removeClass('fa fa-close');
              b.addClass('fa fa-edit');
              $('#view-info').show();
              $('#edit-info').hide();
          }
      });
